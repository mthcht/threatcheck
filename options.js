var SERVICES=[
  ...
  {id:"abuseipdb",name:"AbuseIPDB",cat:"Threat Intel",types:["IP","Domain"],color:"#00b4d8",needsApi:false,fields:[{key:"abuseipdb_key",label:"API Key (optional - enables auto-check)",ph:"Your AbuseIPDB API key"}]},
  ...
  {id:"opencti",name:"OpenCTI",cat:"Threat Intel",types:["All"],color:"#001bda",needsApi:true,fields:[{key:"opencti_url",label:"Instance URL",ph:"https://opencti.yourorg.com"},{key:"opencti_token",label:"API Token",ph:"Your OpenCTI token"}]},
  {id:"recordedfuture",name:"Recorded Future",cat:"Threat Intel",types:["All"],color:"#e63946",needsApi:true,fields:[{key:"rf_token",label:"API Token",ph:"RF token"}]},
  {id:"ipinfo",name:"IPInfo",cat:"Network Intel",types:["IP"],color:"#0984e3",needsApi:false},
  {id:"spur",name:"Spur",cat:"Network Intel",types:["IP"],color:"#6c5ce7",needsApi:true,fields:[{key:"spur_token",label:"API Token",ph:"Your Spur API token"}]},
  ...
  {id:"urlscan",name:"URLScan.io",cat:"URL / Domain",types:["URL"],color:"#00cec9",needsApi:false,fields:[{key:"urlscan_key",label:"API Key (optional - enables auto-search)",ph:"Your URLScan API key"}]},
  {id:"wayback",name:"Wayback Machine",cat:"URL / Domain",types:["URL","Domain"],color:"#636e72",needsApi:false},
  {id:"dnsdumpster",name:"DNSDumpster",cat:"URL / Domain",types:["Domain"],color:"#2d3436",needsApi:true,fields:[{key:"dnsdumpster_key",label:"API Key",ph:"Your DNSDumpster API key"}]},
  ...
  {id:"leakcheck",name:"LeakCheck",cat:"Code & Leaks",types:["Email"],color:"#fd79a8",needsApi:true,fields:[{key:"leakcheck_key",label:"API Key",ph:"Your LeakCheck API key"}]},
